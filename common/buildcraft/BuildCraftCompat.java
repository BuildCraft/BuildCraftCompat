...
@Mod(name = "BuildCraft Compat", version = "@VERSION@", useMetadata = false, modid = "BuildCraft|Compat", acceptedMinecraftVersions = "[1.8.9]",
        dependencies = "required-after:Forge@[11.15.1.1744,);required-after:BuildCraft|Core;after:Forestry;after:BuildCraft|Transport;after:BuildCraft|Builders;after:ThermalExpansion")
public class BuildCraftCompat extends BuildCraftMod {
    ...
    public void preInit(final FMLPreInitializationEvent evt) {
        ...
        // this.offerModule(new BCPluginJEI());
