...
//        return new TextComponent("Distillable Fluids");
        return Component.translatable("buildcraft.jei.title.distillable_fluids");
    }
...
//    public void drawExtras(Minecraft minecraft)
    public void draw(IRefineryRecipeManager.IDistillationRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        this.background.draw(guiGraphics, 20, 4);
        this.slot.draw(guiGraphics, 0, 25);
        this.slot.draw(guiGraphics, 56, 0);
        this.slot.draw(guiGraphics, 56, 45);

        this.animated.draw(guiGraphics, 20, 4);
        guiGraphics.drawString(this.font, MjAPI.formatMj(recipe.powerRequired()) + " MJ", 58, 28, Color.CYAN.getRGB());
    }
