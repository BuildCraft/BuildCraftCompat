...
//        return new TextComponent("Coolable Fluids");
        return Component.translatable("buildcraft.jei.title.coolable_fluids");
    }
...
//    public void drawExtras(Minecraft minecraft)
    public void draw(IRefineryRecipeManager.ICoolableRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        // Calen: y+1 to be at the same height as tubes of background
        // in 1.18.2 additionally +1
//        this.slot.draw(stack, 0, 0);
        this.slot.draw(guiGraphics, 0, 1);
//        this.slot.draw(stack, 72, 0);
        this.slot.draw(guiGraphics, 72, 1);

        // Calen: top padding add 2 to be same height as heatable
//        this.animatedCooling.draw(stack, 18, 0);
        this.animatedCooling.draw(guiGraphics, 18, 2);
//        this.animatedHeating.draw(stack, 18, 0);
        this.animatedHeating.draw(guiGraphics, 18, 2);
    }
